...
- ไปที่เมนู Settings > Proxy & Forwarders
    ...
    - Forwarders: กรอก IP Address ของ DNS Server ที่ต้องการใช้งาน
        ...
        ![technitium-dns-3](/img/technitium-dns-3.png)
...
- ไปที่เมนู Zones
    ...
    ![technitium-dns-4](/img/technitium-dns-4.png)
...
- คลิกปุ่ม Add
    ...
    ![technitium-dns-5](/img/technitium-dns-5.png)

- หลังจากสร้างโซนแล้ว จะมีหน้าต่างให้เพิ่ม DNS Records

    ![technitium-dns-6](/img/technitium-dns-6.png)
...
- คลิกปุ่ม Save
    ...
    ![technitium-dns-7](/img/technitium-dns-7.png)

- หลังจากเพิ่ม A record แล้ว จะเห็นรายการในหน้า Zone

    ![technitium-dns-8](/img/technitium-dns-8.png)
...
- คลิกปุ่ม Add
    ...
    ![technitium-dns-9](/img/technitium-dns-9.png)

- หลังจากสร้างโซนแล้ว จะมีหน้าต่างให้เพิ่ม DNS Records

    ![technitium-dns-10](/img/technitium-dns-10.png)
...
- คลิกปุ่ม Save
    ...
    ![technitium-dns-11](/img/technitium-dns-11.png)

- หลังจากเพิ่ม PTR record แล้ว จะเห็นรายการในหน้า Zone

    ![technitium-dns-12](/img/technitium-dns-12.png)
...
- ไปที่ Network and Internet
    ...
    ![technitium-dns-13](/img/technitium-dns-13.png)

- คลิก Network and Sharing Center

    ![technitium-dns-14](/img/technitium-dns-14.png)

- คลิก Change adapter settings

    ![technitium-dns-15](/img/technitium-dns-15.png)

- คลิกขวาที่ Network Adapter ที่ใช้งานอยู่ (เช่น Ethernet หรือ Wi-Fi) แล้วเลือก Properties

    ![technitium-dns-16](/img/technitium-dns-16.png)

    ![technitium-dns-17](/img/technitium-dns-17.png)

- เลือก Internet Protocol Version 4 (TCP/IPv4) แล้วคลิก Properties

    ![technitium-dns-18](/img/technitium-dns-18.png)
...
- เลือก "Use the following DNS server addresses"
    ...
    ![technitium-dns-19](/img/technitium-dns-19.png)
